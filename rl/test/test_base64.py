import pytest
import random
from lsutils import encode_float64_to_base64, decode_base64_float64
...
def test_encode_decode_roundtrip():
    ...
    for _ in range(10):
        ...
        decoded = decode_base64_float64(encoded)
...
def test_known_values():
    ...
    for value, encoded_str in test_cases.items():
        ...
        assert decode_base64_float64(encoded_str) == value
...
def test_decode_invalid_base64_string():
    ...
    with pytest.raises(ValueError, match="Invalid base64 string"):
        decode_base64_float64("not-a-base64-string!")
